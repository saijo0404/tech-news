...
- **來源**: Google Blog
- **發布日期**: 2026-06-30
- **原文連結**: https://blog.google/innovation-and-ai/models-and-research/gemini-models/gemini-omni-flash-nano-banana-2-lite/
...
- **模型串聯與示範應用**：開發者可將 Nano Banana 2 Lite 產生的影像作為 Gemini Omni Flash 的參考輸入，將靜態影像動畫化為影片。Google 提供三款示範應用——Anywhere（自拍轉地標動畫）、Space Lift（室內設計概念轉影片）、Omni Product Studio（靜態商品圖轉電商影片），並可透過 Interactions API 維護多輪對話上下文。
